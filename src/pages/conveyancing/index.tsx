...
const conveyancingPage = () => {
	return (
		<>
			<HeroSection title="Buying or selling?" sectionClasses="px-4 lg:px-0" subTitle="Redeem your $220 conveyancing voucher and free contract review" classes="flex flex-col-reverse lg:flex-row lg:justify-between" subTitleClasses="lg:text-base">
