	...
	return (
		<div className="border rounded-xl mt-8 lg:absolute lg:w-[38%] lg:right-0 lg:top-0 lg:mt-0">
			...
			<form onSubmit={handleSubmit(onSubmit)} className="px-4">
				<InputField label="First Name" type="text" name="firstname" error={errors.firstname?.message} register={{ ...register("firstname", { required: "Firstname is required" }) }} />
				<InputField label="Last Name" type="text" name="lastname" error={errors.lastname?.message} register={{ ...register("lastname", { required: "Lastname is required" }) }} />
				<InputField
					label="Email"
					name="email"
					type="email"
